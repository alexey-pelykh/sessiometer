...
| [0022](0022-session-trigger-one-predicate-two-estimators.md) | `session_trigger` is one predicate on two estimators of the same quantity, not two knobs | Accepted |
