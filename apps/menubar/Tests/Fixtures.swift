...
enum Fixtures {
    ...
    {"type":"snapshot","schema_version":{"major":1,"minor":5},"generated_at":1893456100,"accounts":[{"label":"work","active":true,"enabled":true,"quarantined":false,"recovering":false,"session_pct":95,"weekly_pct":100,"session_resets_at":1893460500,"weekly_resets_at":1893800500,"weekly_exhausted":true,"access_expires_at":1893470500,"refresh_health":{"last_ok":false,"rotated":false,"consecutive_failures":2},"auth":"stale"}],"next_swap":{"state":"no_viable_target","cause":"weekly","resets_at":1893800500},"refresh_enabled":true,"systemic_refresh_failure":null}
    """#
    ...
    {"type":"snapshot","schema_version":{"major":1,"minor":5},"generated_at":1893456200,"accounts":[{"label":"work","active":false,"enabled":true,"quarantined":true,"recovering":false,"session_pct":null,"weekly_pct":null,"session_resets_at":null,"weekly_resets_at":null,"weekly_exhausted":false,"access_expires_at":null,"refresh_health":null,"auth":"dead"}],"next_swap":{"state":"awaiting_data"},"refresh_enabled":false,"systemic_refresh_failure":null}
    """#
    ...
    {"type":"snapshot","schema_version":{"major":1,"minor":5},"generated_at":100,"accounts":[],"next_swap":null,"refresh_enabled":false,"systemic_refresh_failure":null}
    """#
    ...
    {"type":"heartbeat","generated_at":42,"schema_version":{"major":1,"minor":5}}
    """#
    ...
    /// error, NOT a tolerated unknown — a mis-rendered fleet state is dangerous). Minor 6 marks a NEWER
    /// daemon that added a `canonical_scrub` variant this client cannot read.
    static let snapshotUnknownCanonicalScrub = #"""
    {"type":"snapshot","schema_version":{"major":1,"minor":6},"generated_at":1,"accounts":[],"next_swap":null,"refresh_enabled":false,"canonical_scrub":{"state":"future_state"}}
    """#
