...
//! `sha256(CLAUDE_CONFIG_DIR)[..8]` suffix, and the redaction METER's
//! hashed-leak fingerprint ([`crate::redaction`], test-only). Verified against
//! the NIST `""`, `"abc"`, and 448-bit-boundary vectors below.
